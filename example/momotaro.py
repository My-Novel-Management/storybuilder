...
def sc_getpeach(w: World):
    ...
    return w.scene("大きな桃", w.comment("桃を拾う"),
            ...
            _.think("寂しい", D.pT("寂しい暮らしを送っていた")),
            granpa.go("芝刈り", "#$Sは山に芝刈りに、"),
            granma.come("洗濯", "#T$Sは川へ洗濯に出かけた"),
            granma.have(w.washing),
            w.load("river"),
            w.load("granma_base"),
            granma.look("白髪混じりで細い髪質"),
            granma.move("川岸に",D.p("川へやってきた$Sは")),
            peach.come(D.pT("桃が流れてくるのに気づいた")),
            peach.look("人間が二人掛かりで持てそうな大きさ",
                D.p("それはとても大きく、とても細腕の老婆一人では持ち上げられそうにないほどで、")),
            peach.look("しっかりと色づき美味しそう",
                D.pT("水に浮かびながらその色づいた表面を見せ、どんぶらことやってくる")),
            granma.do("桃を拾う", D.p("$Sは流れてきた桃を木の棒で引き寄せると、")),
            _.do("手に入れる", D.pT("手を伸ばしてそれを何とか岸に引き上げた"),),
