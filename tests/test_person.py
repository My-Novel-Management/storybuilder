...
class PersonTest(unittest.TestCase):
    ...
    def test_attributes(self):
        data = [
                ("太郎", "山田", "太郎", "山田,太郎", "山田・太郎",
                    17, "male", "学生", "me:俺", "a man",
                    "山田太郎", {"me":"俺","S":"太郎","M":"俺"}, "a man", False),
                ("太郎", "山田", "太郎", "山田,太郎", "山田・太郎",
                    17, "male", "学生", "me:俺", None,
                    "山田太郎", {"me":"俺","S":"太郎","M":"俺"}, Person.__NOTE__, False),
                ("太郎", "山田", "太郎", "山田,太郎", "山田・太郎",
                    17, "male", "学生", None, None,
                    "山田太郎", {"me":"私","S":"太郎","M":"私"}, Person.__NOTE__, False),
                (1, "山田", "太郎", "山田,太郎", "山田・太郎",
                    17, "male", "学生", "me:俺", "a man",
                    "山田太郎", {"me":"俺","S":"太郎","M":"俺"}, "a man", True),
                ("太郎", "山田", "太郎", 1, "山田・太郎",
                    17, "male", "学生", "me:俺", "a man",
                    "山田太郎", {"me":"俺","S":"太郎","M":"俺"}, "a man", True),
                ("太郎", "山田", "太郎", "山田,太郎", "山田・太郎",
        ...
        for name, lastname, firstname, fullname, exfullname, age, sex, job, calling, note, exp_fullname, exp_calling, exp_note, isfail in data:
            with self.subTest():
                if not isfail:
                    _checkcode(name, lastname, firstname, fullname, exfullname,
                            age, sex, job, calling, note, exp_fullname, exp_calling, exp_note)
                else:
    ...
    def test_inherited(self):
        ...
        data = [
                ("花子", "田中", "花子", "田中,花子", "田中・花子",
                    16, "female", "高校生", "me:私", "a girl",
                    "田中花子", {"me":"私","S":"花子","M":"私"}, "a girl", False),
                (1, "田中", "花子", "田中,花子", "田中・花子",
                    16, "female", "高校生", "me:私", "a girl",
                    "田中花子", {"me":"私","S":"花子","M":"私"}, "a girl", True),
                ]
        ...
        for name, lastname, firstname, fullname, exfullname, age, sex, job, calling, note, exp_fullname, exp_calling, exp_note, isfail in data:
            with self.subTest():
                if not isfail:
                    _checkcode(name, lastname, firstname, fullname, exfullname, age, sex, job, calling, note, exp_fullname, exp_calling, exp_note)
                else:
                    with self.assertRaises((AssertionError, TypeError)):
                        _checkcode(name, lastname, firstname, fullname, exfullname, age, sex, job, calling, note, exp_fullname, exp_calling, exp_note)
