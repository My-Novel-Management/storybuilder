...
class HeaderInfoTest(unittest.TestCase):
    ...
    def test_instance(self):
        data = [
                ...
                (True, 9, 1, 10, 100, 5, 5, 5, 5,
                    9, 1, 10, 100, 5,5,5,5),
                ]
        def checker(total, chars, lines, papers, chapters, episodes, scenes, scodes,
                exp_total, exp_chars, exp_lines, exp_papers, exp_chaps, exp_epis, exp_scenes, exp_scodes):
            tmp = hd.HeaderInfo(total, chars, lines, papers, chapters, episodes, scenes, scodes)
